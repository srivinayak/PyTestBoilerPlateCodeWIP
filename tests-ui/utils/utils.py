...
def get_env_name(caps: dict):
    ...
    logger.info('Test results will be exported to "%s" TestRail Configuration' % env_name)
    return env_name


def initialize_screenshot_dirs(root_dir):
    logger.info("About to initialize screenshot directories")
    ...
    logger.info("Initialized the screenshot directories")
