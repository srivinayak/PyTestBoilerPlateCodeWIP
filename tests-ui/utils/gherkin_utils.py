...
def data_table_vertical_converter(data_table_raw: str):
    logger.info("Vertical conversion of data table started")
    ...
    vertical_conversion = {data_table_list[i]: data_table_list[i + 1] for i in range(0, len(data_table_list) - 1, 2)}
...
def data_table_horizontal_converter(data_table_raw: str):
    logger.info("Horizontal conversion of data table started")
    ...
    logger.info("Output of horizontal conversion of data table is: ", data_table)
    return data_table
